<div id="heading-breadcrumbs">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
          <h1><?= $Lang->get('VOTE__TITLE') ?></h1>
      </div>
      <div class="col-md-4">
  			<button data-toggle="modal" data-target="#rewards" class="btn btn-template-main transparent btn-block"><?= $Lang->get('VOTE__REWARDS_TITLE') ?></button>
  			<button data-toggle="modal" data-target="#ranking" class="btn btn-template-main transparent btn-block"><?= $Lang->get('VOTE__RANKING_TITLE') ?></button>
      </div>
    </div>
  </div>
</div>
    				...
    				<div class="panel panel-default panel-step step1" style="opacity : 0.5;">
    				  ...
    				  <div class="panel-body">
    				    <form class="form-inline" data-ajax="true" action="<?= $this->Html->url(array('action' => 'setPseudo')) ?>" data-callback-function="step1">
    					  	...
    					  	<button type="submit" class="btn btn-template-main btn-lg btn-step1 disabled" disabled><?= $Lang->get('USER__LOGIN') ?></button>
    						</form>
    				  </div>
    				</div>
    			...
    			<!-- Vote -->
    				<div class="panel panel-default panel-step step2" style="opacity : 0.5;">
    				  ...
    				  <div class="panel-body">
    				  	...
    				  	<a class="btn btn-template-main btn-block btn-step2 disabled" href="#" target="_blank">Voter</a>
    				  </div>
    				</div>
